...
/////////////////
const BotName = '★MRF BOT★'; 
const instagram = 'https://instagram.com/muhammad_ramzi_firdaus'; 
const telegram = 'https://t.me/muhammadramzifirdaus'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/muhammadramzifirdaus';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@muhammad_ramzi_firdaus')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@muhammad_ramzi_firdaus`)
})
